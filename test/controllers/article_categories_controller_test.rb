...
class ArticleCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create article_category" do
    assert_difference('ArticleCategory.count') do
      post :create, article_category: { icon: @article_category.icon, image: @article_category.image, title: @article_category.title }
    end
  ...
  test "should update article_category" do
    patch :update, id: @article_category, article_category: { icon: @article_category.icon, image: @article_category.image, title: @article_category.title }
    assert_redirected_to article_category_path(assigns(:article_category))
  end
